...
start_date = '20240401'
sql = f"""SELECT * FROM tushare_stock.trade_cal WHERE cal_date > '{start_date}' order by cal_date asc LIMIT 1000"""
...
#
# sql = """SELECT * FROM limit_list_d WHERE trade_date > '20240408' LIMIT 1000"""
# df = pd.read_sql_query(sql, engine_ts)
#
# # print(df)
#
# trade_dates_sorted = sorted(set(df['trade_date'].values), reverse=False)
#
